...
# Species
speciesData = r"C:\GFW\Amphibians_filtered_generalised.gdb\Amphibians_filtered_generalised"
speciesID = 'id_no'

hexagonData = r"G:\GEFStar_Moll1km.gdb\snapID1km_pnt"
hexagonID = "pointid"
output_result_path = r'C:\GFW\amphib_2017_reso1km.csv.gz'
log_path = r"C:\GFW\amphib_2017_reso1km.csv_log.csv"



# Species_failed
##speciesData = r"C:\GFW\Amphibians_filtered_generalised.gdb\amphib_species_failed"
##speciesID = 'row_id'

##hexagonData = r"G:\GEFStar_Moll1km.gdb\snapID1km_pnt"
##hexagonID = "pointid"
##output_result_path = r'C:\GFW\amphib_2017_reso1km_add.csv.gz'
##log_path = r"C:\GFW\amphib_2017_reso1km.csv_log_add.csv"


# Species_failed dice method
##speciesData = r"C:\GFW\Amphibians_filtered_generalised.gdb\amphib_species_failed_dice"
##speciesID = 'row_id'

##hexagonData = r"G:\GEFStar_Moll1km.gdb\snapID1km_pnt"
##hexagonID = "pointid"
##output_result_path = r'C:\GFW\amphib_2017_reso1km_add_dice.csv.gz'
##log_path = r"C:\GFW\amphib_2017_reso1km.csv_log_add_dice.csv"


# Species_failed dice method
##speciesData = r"C:\GFW\Amphibians_filtered_generalised.gdb\amphib_species_failed_dice_still_fail_fix"
##speciesID = 'row_id'

##hexagonData = r"G:\GEFStar_Moll1km.gdb\snapID1km_pnt"
##hexagonID = "pointid"
##output_result_path = r'C:\GFW\amphib_2017_reso1km_add_dice_still_fail.csv.gz'
##log_path = r"C:\GFW\amphib_2017_reso1km.csv_log_add_dice_still_fail.csv"
